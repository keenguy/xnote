...
md.use(require('markdown-it-task-lists')).use(require('markdown-it-footnote'))
    .use( require("markdown-it-anchor") ).use(require('markdown-it-attrs'))
    .use(require('./markdown-toc'),{output: md.output})
    .use(require('./markdown-mathjax'), {output: md.output})
