...
const webviews = {
    ...
    add: function (tabId) {
        ...
        if (tabData.url) {
            ipc.send('loadURLInView', {id: tabData.id, url: url})
        }
...
ipcRenderer.on('view-event', function (e, args) {
...
// ipcRenderer.on('captureData', function (e, data) {
...
ipcRenderer.on('windowFocus', function () {
